...
! mpi_mint64: datatype, integer64
     integer, private, parameter :: mpi_mint64   = MPI_INTEGER8
...
! readucing int
     private :: mp_reduce_int64

! reducing int(:)
     private :: mp_reduce_int1

! reducing int(int64)(:)
     private :: mp_reduce_int164
...
! allreducing int
     private :: mp_allreduce_int64

! allreducing int(:)
     private :: mp_allreduce_int1

! allreducing int(:) with int64
     private :: mp_allreduce_int164

! allreducing int(:,:)
     private :: mp_allreduce_int2

! allreducing int(:,:) with int64
     private :: mp_allreduce_int264
...
! mpi_bcast subroutines
     ...
     interface mp_bcast
         ...
         module procedure mp_bcast_int64
...
! mpi_reduce subroutines
     ...
     interface mp_reduce
         ...
         module procedure mp_reduce_int64
         module procedure mp_reduce_int1
         module procedure mp_reduce_int164
...
! mpi_allreduce subroutines
     ...
     interface mp_allreduce
         ...
         module procedure mp_allreduce_int64
         module procedure mp_allreduce_int1
         module procedure mp_allreduce_int164
         module procedure mp_allreduce_int2
         module procedure mp_allreduce_int264
...
! mp_bcast_bool: broadcasts char from the process with rank "root"
     subroutine mp_bcast_char(data, root, gid)
         implicit none
...
! handler for return code
         call mp_error('mp_bcast_char', ierror)
...
! mp_bcast_int: broadcasts int from the process with rank "root"
     subroutine mp_bcast_int64(data, root, gid)
         implicit none
...
! invoke realted MPI subroutines
         call MPI_BCAST(data, 1, mpi_mint64, root, group, ierror)

! handler for return code
         call mp_error('mp_bcast_int', ierror)

         return
     end subroutine mp_bcast_int64
...
! mp_reduce_int: reduce 1 integer from all processes
     subroutine mp_reduce_int64(source, data, root, gid)
         implicit none
...
! invoke related mpi subroutines
         call MPI_REDUCE(source, data, 1, mpi_mint64, mpi_sum, root, group, ierror)

! handler for return code
         call mp_error('mp_reduce_int', ierror)

         return
     end subroutine mp_reduce_int64
...
! mp_reduce_int1: reduce integer vector from all processes
     subroutine mp_reduce_int164(source, data, root, gid)
         implicit none
...
! invoke related mpi subroutines
         call MPI_REDUCE(source, data, isize, mpi_mint64, mpi_sum, root, group, ierror)

! handler for return code
         call mp_error('mp_reduce_int1', ierror)

         return
     end subroutine mp_reduce_int164
...
! mp_allreduce_int: reduce 1 integer from all processes
     subroutine mp_allreduce_int64(source, data, gid)
         implicit none
...
! invoke related mpi subroutines
         call MPI_ALLREDUCE(source, data, 1, mpi_mint64, mpi_sum, group, ierror)

! handler for return code
         call mp_error('mp_allreduce_int', ierror)

         return
     end subroutine mp_allreduce_int64
...
! mp_allreduce_int1: reduce integer vector from all processes
     subroutine mp_allreduce_int164(source, data, gid)
         implicit none
...
! invoke related mpi subroutines
         call MPI_ALLREDUCE(source, data, isize, mpi_mint64, mpi_sum, group, ierror)

! handler for return code
         call mp_error('mp_allreduce_int164', ierror)

         return
     end subroutine mp_allreduce_int164
...
! mp_allreduce_int264: reduce integer64 matrix from all processes
     subroutine mp_allreduce_int264(source, data, gid)
         implicit none
...
! handler for return code
         ...
         return
     end subroutine mp_allreduce_int264
